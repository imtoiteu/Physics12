...
mc("Trong hệ toạ độ (p, T), đường đẳng tích của một lượng khí lí tưởng xác định là",
   ["đường thẳng đi qua gốc toạ độ.", "đường thẳng song song với trục T.",
    "một nhánh hypebol.", "đường cong bất kì."],
   "A",
   "Từ p = (nR/V)·T, khi V không đổi thì p tỉ lệ thuận với T: đồ thị là đường thẳng qua gốc toạ độ.",
   "Quá trình đẳng tích – đồ thị", TB, fig="k_dt_dangtich",
...
mc("Trong quá trình đẳng nhiệt, nếu thể tích khí giảm 3 lần thì mật độ phân tử khí",
   ...
   "C",
   "Số phân tử N không đổi, thể tích giảm 3 lần nên mật độ N/V tăng 3 lần — đó cũng chính là lí do áp "
   "suất tăng 3 lần.",
   "Mô hình động học phân tử", TB),
...
sa("Đun nóng đẳng áp một lượng khí từ 27 °C lên 177 °C. Thể tích ban đầu 5,0 L. Thể tích lúc sau bằng bao "
   "nhiêu lít?",
   "7,5", "T₁ = 300 K, T₂ = 450 K ⟹ V₂ = 5,0 · 450/300 = 7,5 L.", "Định luật Charles", D),
...
sa("Với chu trình ở hình bên, tỉ số giữa nhiệt độ ở trạng thái (3) và nhiệt độ ở trạng thái (1) bằng bao nhiêu?",
   "9", "T ∝ pV ⟹ T₃/T₁ = (3·3)/(1·1) = 9.", "Đọc giản đồ p–V", TB,
...
ds("Một xilanh thẳng đứng chứa cột khí cao 30 cm ở 27 °C, áp suất 10⁵ Pa, phía trên là pit-tông nhẹ dịch "
   ...
   [("Giai đoạn đầu (trước khi pit-tông chạm vấu) là quá trình đẳng áp.", True,
    ...
    ("Pit-tông chạm vấu chặn khi nhiệt độ khí đạt 360 K.", True,
     "Đúng. Đẳng áp: T₂ = 300 · 36/30 = 360 K."),
    ("Sau khi pit-tông chạm vấu, tiếp tục đun thì quá trình trở thành đẳng tích.", True,
     "Đúng. Vấu chặn giữ pit-tông lại nên thể tích không tăng được nữa; từ đó áp suất bắt đầu tăng."),
    ("Nhiệt độ để áp suất khí đạt 1,5·10⁵ Pa là 450 K.", False,
     "Sai. Phải xuất phát từ trạng thái lúc chạm vấu: T₃ = 360 · 1,5/1,0 = 540 K. Giá trị 450 K là kết "
     "quả sai khi áp thẳng định luật đẳng tích từ trạng thái ban đầu, bỏ qua chặng đẳng áp.")],
   "Xilanh có vấu chặn – hai chặng", RK),
...
sa("Xilanh thẳng đứng chứa cột khí cao 30 cm ở 27 °C, áp suất 10⁵ Pa; vấu chặn cách pit-tông 6 cm. Đun "
   "nóng chậm tới khi áp suất khí đạt 1,5·10⁵ Pa. Nhiệt độ khi đó bằng bao nhiêu kelvin?",
   "540",
   "Chặng 1 (đẳng áp): T₂ = 300 · 36/30 = 360 K khi pit-tông chạm vấu.\n"
   "Chặng 2 (đẳng tích): T₃ = 360 · 1,5/1,0 = 540 K.",
   "Xilanh có vấu chặn – hai chặng", RK),
...
sa("Quả bóng thể tích không đổi 3,0 L chứa khí ở 27 °C, áp suất 2,0·10⁵ Pa. Cần lấy ra bao nhiêu phần "
   "trăm lượng khí để áp suất còn 1,2·10⁵ Pa ở cùng nhiệt độ?",
   "40", "V, T không đổi ⟹ m ∝ p: m₂/m₁ = 1,2/2,0 = 0,60 ⟹ lấy ra 40%.",
   "Lượng khí thay đổi", TB),
])
...
P3=[
sa("Một chất khí có mật độ phân tử 2,4·10²⁵ m⁻³, khối lượng mỗi phân tử 5,0·10⁻²⁶ kg, tốc độ căn quân "
   "phương 500 m/s. Áp suất khí bằng bao nhiêu (đơn vị 10⁵ Pa)?",
   "1", "p = (1/3)μ·m·v̄² = (1/3) · 2,4·10²⁵ · 5,0·10⁻²⁶ · 2,5·10⁵ = 1,0·10⁵ Pa.",
   "Áp suất theo mô hình động học phân tử", K),

sa("Không khí ở áp suất 10⁵ Pa có khối lượng riêng 1,2 kg/m³. Tốc độ căn quân phương của phân tử không "
   "khí bằng bao nhiêu m/s?",
   "500", "Từ p = (1/3)ρv̄² ⟹ v̄² = 3p/ρ = 3·10⁵/1,2 = 2,5·10⁵ ⟹ v = 500 m/s.",
   "Áp suất – tốc độ phân tử", K),
...
sa("Cần bơm bao nhiêu lần bằng bơm có thể tích xilanh 0,25 L (khí ở 10⁵ Pa) để áp suất trong bình 5,0 L "
   "tăng từ 10⁵ Pa lên 2,0·10⁵ Pa (nhiệt độ không đổi)?",
   "20",
   "2,0 · 5,0 = 1,0 · 5,0 + n · 1,0 · 0,25 (đơn vị 10⁵ Pa·L) ⟹ 0,25n = 5,0 ⟹ n = 20 lần.",
   "Bơm khí", K),
...
ds("Một cột khí bị giam trong ống một đầu kín bởi cột thuỷ ngân dài h. Áp suất khí quyển là 75 cmHg, "
   ...
   [("Khi dựng ống thẳng đứng miệng hướng lên, áp suất khí bị giam là 75 + h (cmHg).", True,
    ...
    ("Chiều dài cột khí khi dựng ống thẳng đứng miệng hướng lên luôn nhỏ hơn khi nằm ngang, với mọi giá "
     "trị h > 0.", True,
     "Đúng. p tăng từ 75 lên 75 + h nên theo định luật Boyle ℓ phải giảm; đây là kết luận định tính rất "
     "hữu ích để kiểm tra nhanh kết quả tính toán.")],
   "Cột khí bị giam – bài toán ngược", RK, fig="k_sd_ong_khi",
   cap="Ống chứa cột khí bị giam"),
],
P3=[
...
sa("Một lượng khí lí tưởng được nung đẳng áp thêm 60 K thì thể tích tăng 20%. Nhiệt độ ban đầu của khí "
   "bằng bao nhiêu kelvin?",
   "300", "(T + 60)/T = 1,20 ⟹ 0,20T = 60 ⟹ T = 300 K (tức 27 °C).",
   "Định luật Charles – bài toán ngược", K),
