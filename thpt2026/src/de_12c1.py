...
mc("Hình vẽ là đồ thị nhiệt độ theo thời gian của một chất lỏng để nguội trong không khí. Nhiệt độ đông "
   ...
   ["60 °C.", "70 °C.", "80 °C.", "90 °C."],
   "C",
   "Đoạn nằm ngang của đường nguội lạnh ứng với quá trình đông đặc; đọc trên trục tung được 80 °C.",
...
mc("Hình vẽ là đồ thị nhiệt độ theo thời gian khi nung nóng 1,0 kg chì bằng thiết bị có công suất không "
   ...
   "C",
   "Đoạn nằm ngang của đồ thị ứng với quá trình nóng chảy; đọc trên trục tung được 327 °C.",
...
ds("Hình vẽ là đồ thị nhiệt độ theo thời gian khi nung nóng 1,0 kg chì bằng thiết bị công suất không đổi "
   ...
   [("Trong 390 giây đầu, toàn bộ khối chì ở thể rắn.", True,
    ...
    ("Nhiệt lượng cần để đưa khối chì từ 27 °C lên 327 °C lớn hơn nhiệt lượng cần để làm nó nóng chảy "
     "hoàn toàn.", True,
...
P2=[
ds("Dẫn 20 g hơi nước ở 100 °C vào bình cách nhiệt chứa 200 g nước đá ở 0 °C. Cho L = 2,26·10⁶ J/kg, "
   "λ = 3,4·10⁵ J/kg, c_nước = 4200 J/(kg·K).",
   [("Nhiệt lượng do hơi nước toả ra khi ngưng tụ hoàn toàn ở 100 °C là 45,2 kJ.", True,
     "Đúng. Q = Lm = 2,26·10⁶ · 0,020 = 45 200 J."),
    ("Tổng nhiệt lượng mà lượng hơi nước đó có thể nhường cho nước đá là 53,6 kJ.", True,
     "Đúng. Ngoài 45,2 kJ khi ngưng tụ, phần nước tạo thành còn nguội từ 100 °C xuống 0 °C, toả thêm "
     "0,020 · 4200 · 100 = 8400 J; tổng 53 600 J."),
    ("Toàn bộ 200 g nước đá sẽ tan hết.", False,
     "Sai. Làm tan hết 200 g đá cần 68 kJ, lớn hơn 53,6 kJ mà hơi nước có thể cung cấp; đá chỉ tan "
     "khoảng 158 g."),
    ("Khi cân bằng nhiệt, trong bình có khoảng 178 g nước ở thể lỏng.", True,
     "Đúng. Lượng đá tan ≈ 158 g, cộng với 20 g nước do hơi ngưng tụ tạo thành: 158 + 20 = 178 g nước; "
     "phần còn lại khoảng 42 g vẫn là đá, tất cả ở 0 °C.")],
   "Cân bằng nhiệt nhiều giai đoạn", K),
...
sa("Trong đường nung nóng nước đá ở hình bên, tỉ số giữa nhiệt lượng cung cấp cho giai đoạn đun nước "
   "(0 → 100 °C) và nhiệt lượng cung cấp cho giai đoạn làm nóng nước đá (−20 → 0 °C) bằng bao nhiêu?",
   "10",
   "Cùng công suất nên nhiệt lượng tỉ lệ thuận với thời gian: Q₃/Q₁ = 500/50 = 10.",
...
mc("Bình 1 chứa 1,0 kg nước ở 80 °C, bình 2 chứa 1,0 kg nước ở 20 °C, cả hai đều cách nhiệt. Múc 0,5 kg "
   "nước từ bình 1 sang bình 2, khuấy đều; sau đó múc 0,5 kg nước từ bình 2 trở lại bình 1. Nhiệt độ nước "
   "ở bình 1 khi đó là",
   ["50 °C.", "55 °C.", "60 °C.", "65 °C."],
   "C",
   "Bước 1 – bình 2: (1,0 · 20 + 0,5 · 80)/1,5 = 60/1,5 = 40 °C; bình 1 còn 0,5 kg ở 80 °C.\n"
   "Bước 2 – bình 1: (0,5 · 80 + 0,5 · 40)/1,0 = 60/1,0 = 60 °C.\n"
   "Phải xử lí TUẦN TỰ từng bước, không được trộn gộp cả hai bình.",
...
mc("Đổ 300 g nước ở 90 °C vào một cốc thuỷ tinh khối lượng 200 g đang ở 25 °C. Cho c_thuỷ tinh = "
   ...
   "Chú ý phương án 85,1 °C là kết quả khi bỏ sót phần cốc.",
...
P1=[
mc("Thả 2,0 kg nước đá ở −20 °C vào 0,50 kg nước ở 20 °C trong bình cách nhiệt lí tưởng. "
   "Cho c_đá = 2100, c_nước = 4200 J/(kg·K), λ = 3,4·10⁵ J/kg. Trạng thái cuối của hệ là",
   ["toàn bộ ở thể lỏng, nhiệt độ trên 0 °C.",
    "hỗn hợp nước và nước đá ở 0 °C.",
    "toàn bộ ở thể rắn, nhiệt độ dưới 0 °C.",
    "toàn bộ ở thể lỏng, nhiệt độ đúng 0 °C."],
   "B",
   "Bước 1 – so sánh “ngân sách”: nước chỉ nhường được 0,50 · 4200 · 20 = 42 000 J khi hạ tới 0 °C, "
   "trong khi chỉ để HÂM khối đá từ −20 °C lên 0 °C đã cần 2,0 · 2100 · 20 = 84 000 J.\n"
   "Vì 42 000 J < 84 000 J nên nước không những không làm tan được đá mà chính nó sẽ ĐÔNG ĐẶC một phần, "
   "giải phóng thêm nhiệt.\n"
   "Bước 2 – kiểm tra xem nước có đông đặc hết không: nếu đông đặc hết, nước còn nhường thêm "
   "0,50 · 3,4·10⁵ = 170 000 J, tổng cộng 212 000 J > 84 000 J ⟹ chỉ một phần nước đông đặc.\n"
   "Vậy hệ dừng ở 0 °C với cả nước và nước đá cùng tồn tại.",
...
ds("Thả m kg nước đá ở −10 °C vào 1,0 kg nước ở 20 °C trong bình cách nhiệt lí tưởng. Cho c_đá = 2100, "
   "c_nước = 4200 J/(kg·K), λ = 3,4·10⁵ J/kg.",
